...
# (start_hour, end_hour, target_v, target_a, hue_neg, hue_pos, bri_max, label)
_PROFILES = [
    (6,  10, 0.60, 0.40, 9500,  13000, 220, "Aufwachen"),
    (10, 13, 0.65, 0.35, 9000,  11000, 240, "Fokus-Peak"),
    (13, 15, 0.70, 0.45, 9000,  12000, 240, "Anti-Mittagstief"),
    (15, 18, 0.65, 0.30, 9500,  13000, 230, "Nachm.-Fokus"),
    (18, 22, 0.60, 0.00, 8500,  15000, 180, "Entspannung"),
    (22, 24, 0.50, -0.20, 7500, 12000, 100, "Schlaf-Vorbereitung"),
    (0,   6, 0.50, -0.20, 7500, 12000, 100, "Nacht"),
]
...
class CircadianSchedule:
    ...
    def get_params(self, hour: int | None = None) -> dict:
        ...
        for start, end, tv, ta, hn, hp, bm, label in _PROFILES:
            if start <= hour < end:
                return {
                    "target_v": tv,
                    "target_a": ta,
